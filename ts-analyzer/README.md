...
[`flowmap-spring`](../../flowmap-spring)의 결과와 **조인 파일**로 잇는 도구입니다.
...
# --out 은 템플릿 경로이고, 실제 산출은 서비스(프로젝트 루트)별 디렉터리로 나뉩니다:
#   ../json/frontend/<service>/graph.json  (예: .../sample-shop-react/graph.json)
